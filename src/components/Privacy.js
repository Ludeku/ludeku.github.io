  ...
  return (
    <div style={styles.container}>
      ...
      <div>
        ...
        <p>Effective date: September 27, 2018</p>
        <p>Ludeku ("us", "we", or "our") operates the  website (the "Service"), mobile applications and other products ("Games")</p>
        ...
        <ul>
          ...
          <li>To protect and defend the rights or property of our games</li>
        ...
        <ul>
          <li>By email: support@ludeku.net</li>
          <li>By visiting this page on our website: http://ludeku.net
          </li>
        </ul>
      </div>
    </div>
